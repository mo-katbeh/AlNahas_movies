...
-- CREATE UNIQUE INDEX IF NOT EXISTS "user_movie_index" ON "watchlist_items" USING btree ("movie_id","user_id");--> statement-breakpoint
-- CREATE UNIQUE INDEX IF NOT EXISTS "uesr_movie_index" ON "ratings" USING btree ("movie_id","user_id");